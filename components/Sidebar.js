...
const Sidebar = () => {
  // useSession() - to check if someone is signedIn using middleware to check accessToken, if not throw back to login page.
  // Whenever we useSession, we must wrap our app component using SessionProvider.
